...
public class OpnNLPTokenizerExample {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStreamFactory inputStreamFactory = new MarkableFileInputStreamFactory(
				new File("C:\\Users\\abhandeg\\Downloads\\MyNLPProject\\tokenizerdata.txt"));
		...
		model.serialize(new File("C:\\Users\\abhandeg\\Downloads\\MyNLPProject\\OpenNLP_models\\tokenizerdata.bin"));
